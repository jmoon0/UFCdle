...
const Results = () => {
  ...
  return (
    ...
    >
      ...
      <DialogContent className="overflow-y-scroll max-h-[85vh] max-w-[90%] sm:max-w-[45%]">
        <DialogHeader>
            ...
            <div>
              <p className="text-sm text-muted-foreground">
                ...
                <a
                  ...
                  href="https://forms.gle/s4rGBUxU9VMh4ZzAA"
                  target="_blank"
                  rel="nofollow"
                >
                  Contact us.
              ...
              <p className="text-sm text-muted-foreground">
                ...
                <a
                  className="underline hover:text-destructive"
                  href="https://ko-fi.com/moonwater0"
                  target="_blank"
                  rel="nofollow"
                >
                  Send a kofi.
